...
class CategoryOtherPopover: LBTAFormController, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    var newfolderLabel = UILabel(text: "Create Category", font: UIFont(name: "AppleSDGothicNeo-Bold", size: 20)!, textColor: .black, textAlignment: .center, numberOfLines: 0)
    
    var enterfolderLabel = UILabel(text: "Enter a Category name", font: UIFont(name: "AppleSDGothicNeo-SemiBold", size: 15)!, textColor: .darkGray, textAlignment: .center, numberOfLines: 0)
    
    var groupNameTextField = IndentedTextField(placeholder: "Category Name", padding: 24, cornerRadius: 25)
    
    lazy var saveGroupButton = UIButton(title: "Create", titleColor: .white, font: UIFont(name: "AppleSDGothicNeo-SemiBold", size: 18)!, backgroundColor: .rgb(red: 0, green: 172, blue: 237), target: self, action: #selector(saveGroup))

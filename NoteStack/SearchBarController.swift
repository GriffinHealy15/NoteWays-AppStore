...
//  NoteStack
//
//  Created by Griffin Healy on 2/19/20.
...
extension SearchBarController : CLLocationManagerDelegate {
...
extension SearchBarController: HandleMapSearch {
...
extension SearchBarController : MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView?{
        ...
        button.addTarget(self, action: #selector(SearchBarController.getDirections), for: .touchUpInside)
